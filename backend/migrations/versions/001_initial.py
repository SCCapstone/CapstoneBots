...
Tables include: users, projects, commits, blender_objects, object_locks, merge_conflicts, and project_metadata.
"""
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('project_id', 'object_name', name='unique_object_lock'),
    )
    ...
    op.create_table(
        ...
        sa.Column('target_commit_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('object_name', sa.String(), nullable=False),
        ...
        sa.ForeignKeyConstraint(['target_commit_id'], ['commits.commit_id'], ),
